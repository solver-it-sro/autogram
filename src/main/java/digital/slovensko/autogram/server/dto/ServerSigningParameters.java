...
public class ServerSigningParameters {
    ...
    public ServerSigningParameters(SignatureLevel level, ASiCContainerType container,
            ...
            LocalCanonicalizationMethod keyInfoCanonicalization, String schema,
            String transformation, String Identifier, boolean checkPDFACompliance,
            VisualizationWidthEnum preferredPreviewWidth,
